...
/**
 * Default parser for {@link SongChordsSummary} that uses "popular chords" page for parsing.
 *
 * @author Michael Spitsin
 * @since 2014-10-28
 */
public class PopularSongChordsSummaryParser extends ParserFromHTML<SongChordsSummary> {
