...
import com.github.programmerr47.chords.representation.adapter.holder.drawer.DrawerPrimaryItemHolder;
...
public class DrawerPrimaryItemHolderProducer implements HolderProducer {
    ...
    public RecyclerView.ViewHolder produce(ViewGroup parentView) {
        ...
        DrawerPrimaryItemHolder.ResourceParams params = new DrawerPrimaryItemHolder.ResourceParams();
        params.iconResId = R.id.icon;
        params.titleResId = R.id.title;
        return new DrawerPrimaryItemHolder(view, params);
    }
}
